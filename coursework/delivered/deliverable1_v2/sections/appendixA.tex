...
\begin{itemize}
    ...
    \item \textbf{Inferred Operational States:} dynamic metadata classified into generation (\texttt{pv:GenerationState}), systemic disruptions (\texttt{pv:AnomalyState}), control directives (\texttt{pv:AgentAction}), and signal degradation hazards (\texttt{pv:AliasingEvent}).
\end{itemize}
