...
\textbf{H1:} if $f\in\mathcal F_{lock}$, the model is
expected to recover less information about the signal than at nearby non-locked frequencies $f\pm\delta$, measured as higher MDL description length and lower forecast amplitude recovery. No such loss, or a loss that is not localized near $f$, will refute
H1.
