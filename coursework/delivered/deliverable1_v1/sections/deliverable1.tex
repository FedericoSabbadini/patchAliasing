...
where $R_l$ is the representation at layer $l$, $\lVert\cdot\rVert_2$ is the Euclidean norm, and $\varepsilon$ is a pre-registered threshold. This reframes $\mathcal F_{lock}$ as the candidate class where such collisions are hypothesised to occur. In particular, the project will test the following hypotheses.
