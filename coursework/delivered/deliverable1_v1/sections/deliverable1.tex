...
Two set of synthetic signals are used to evaluate the presence of structural aliasing in the new models. These includes:
\begin{itemize}
...
Training ran on one Alienware 16 Aurora (NVIDIA RTX 5060 Laptop GPU, 8\,GB VRAM; 32\,GB RAM), ${\approx}15$,h in total ($2.6$--$4.1$,h per model). 
