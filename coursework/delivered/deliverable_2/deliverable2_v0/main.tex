...
% the sine sweep figures each take a page of their own; the default requires a float
% page to be at least half full, which would send the shorter of the two to the end
