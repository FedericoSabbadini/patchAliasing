...
The token-collapse dips align with the stride grid and shift when the stride changes, consistent with $H3a$; the patch branch is not separately identifiable in the current design.
