...
\subsubsection{$H3b$}
$H3b$ concerns the patch branch and predicts $\kappa_P=1$ in the same way. It is identified by pairs that share a stride and differ in patch size, which the extended set supplies at $S{=}8$.
