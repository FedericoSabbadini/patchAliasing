...
Patch-aligned periodicity thus makes tokens equal as well, but at a spacing of $j$ rather than between neighbours. The two conditions coincide on consecutive patches only in the non-overlapping geometry, where $j=1$.
