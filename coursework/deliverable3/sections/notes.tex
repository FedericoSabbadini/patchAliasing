...
\autoref{sec:one} and \autoref{sec:two} formalise the tokenisation operator and derive the locking condition. \autoref{sec:three} and \autoref{sec:four} fix the semantic layer and state the hypotheses the design must be able to verify. \autoref{sec:five} and \autoref{sec:six} describe the signals and the experiments, \autoref{sec:seven} what they return, \autoref{sec:eight} proposes and discusses one mitigation strategy, \autoref{sec:nine} the agentic deployment and \autoref{sec:ten} the risk assessment. Seven appendices hold the ontology, the Bayesian specifications, the generators, the retraining recipe, the exploratory sweep and the analysis of the telemetry dataset.