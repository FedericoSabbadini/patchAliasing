This appendix states in full the five models summarised in \nameref{sec:four} and listed side by side in \autoref{tab:bayesModels}. For each, what follows gives what it measures, how the measurement is constructed, and what every parameter of it means. The equations are repeated here so that the appendix can be read on its own.
