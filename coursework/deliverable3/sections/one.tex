...
Here and below, for positive integers $A$ and $B$, the notation $A\mid B$ means that $A$ divides $B$, namely $B=qA$ for some $q\in\mathbb{N}^{+}$, viceversa $A\nmid B$.
