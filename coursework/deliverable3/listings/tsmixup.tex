...
\begin{algorithmic}[1]
\Require Frequency pool $\mathcal{P}=\{f_1,\ldots,f_M\}$ in Hz, with $M=397$ spanning $2$ to $150$\,Hz, built from the design as described in this appendix; maximum components $K=10$; symmetric Dirichlet concentration $\alpha=1.5$; draw length $l$, the probing context plus the forecast horizon; sampling frequency $f_s$.
