\begin{table}[!b]
    ...
    \begin{tabular}{@{}lllp{4.9cm}@{}}
        ...
        \bottomrule
    \end{tabular}
    \caption{Every parameter with its prior and its role. Every effect prior is centred on no effect, so a posterior that has not moved away from it is itself a report of an absent effect; the patch-size slope $\delta_P$ is estimable only because the design of \autoref{tab:hfModels} varies $P$ at fixed $S$.}
