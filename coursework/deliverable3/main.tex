...
\newcommand{\rowsep}{\specialrule{0.2pt}{1.5pt}{1.5pt}}
...
\input{sections/B_retraining_appendix.tex}
...
\input{sections/E_bayesian_appendix.tex}
...
\input{sections/G_decomposition_appendix.tex}

\clearpage
\appendixsection{The Photovoltaic Series}{sec:appSolar}
\input{sections/H_solar_appendix.tex}
