...
% Segnaposto per una figura non ancora disponibile: compila, occupa lo spazio che occupera'
% la figura vera, e si vede a colpo d'occhio che manca. L'argomento opzionale e' l'altezza.
\newcommand{\placeholderfig}[2][0.30\textheight]{%
  \fbox{\parbox[c][#1][c]{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}{%
    \centering\textcolor{red}{\textbf{Placeholder figure.} #2}}}}
\newcommand{\valueof}[1]{\textsf{#1}}

% Tabelle in cui una riga occupa piu' di una linea: le righe vanno distinte fra loro senza
% trasformare la tabella in una griglia. \rowtint tinge le righe alternate ed e' quello in uso
% nelle Tabelle 2 e 3; \rowsep e' l'alternativa a filetti, tenuta qui se si vuole tornare indietro.
\newcommand{\rowtint}{\rowcolor{black!6}}
\newcommand{\rowsep}{\arrayrulecolor{black!25}\specialrule{0.4pt}{1.5pt}{1.5pt}\arrayrulecolor{black}}
...
\input{sections/2_agent_behaviour_mitigation.tex}

\section{Signals and Data}\label{sec:signals}
\input{sections/3_signals_data.tex}

\section{Experimental Methodology}\label{sec:methodology}
\input{sections/4_research_questions_methodology.tex}

\section{Results}\label{sec:results}
\input{sections/5_results.tex}

\section{Security Risk Assessment}\label{sec:security}
\input{sections/6_discussion_risk_assessment.tex}
