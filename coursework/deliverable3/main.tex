...
\section{Application Domain}\label{sec:two}
\input{sections/two}

\section{Expected Behaviour at Blind-Spot Frequencies}\label{sec:three}
\input{sections/three}

\section{Signals and Data}\label{sec:four}
\input{sections/four}

\section{Experimental Framework}\label{sec:five}
\input{sections/five}

\section{Results}\label{sec:six}
\input{sections/six}

\section{Mitigation}\label{sec:seven}
\input{sections/seven}

\section{Security Risk Assessment}\label{sec:eight}
