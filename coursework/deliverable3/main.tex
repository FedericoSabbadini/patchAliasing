...
\section{Application Domain and Agent Objectives}\label{sec:domain}
\input{sections/domain}

\section{Patch-Based Tokenisation and Phase Locking}\label{sec:one}
\input{sections/tokenisation_phase_locking}
...
\input{sections/ontology_agent_behaviour}
\endgroup

\subsection{Proposed Mitigation}\label{sec:seven}
\input{sections/mitigation_proposal}
...
\let\subsection\subsubsection
\input{sections/hypotheses_bayesian_models}
\endgroup

\subsection{Signals and Data}\label{sec:four}
\begingroup
\let\subsection\subsubsection
\input{sections/signals_data}
\endgroup
...
\begingroup
\let\subsection\subsubsection
\input{sections/mitigation_discussion}
\endgroup

\subsection{Security Risk Assessment}\label{sec:eight}
\begingroup
\let\subsection\subsubsection
\input{sections/security_risk_assessment}
\endgroup
