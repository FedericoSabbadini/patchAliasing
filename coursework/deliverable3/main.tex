...
\runninghead{Frequency Information Degeneracies in Chronos-Bolt-Tiny Learned Representation} % A shortened article title to appear in the running head, leave this command empty for no running head
...
\title{Frequency Information Degeneracies in Chronos-Bolt-Tiny Learned Representation} % Article title, use manual lines breaks (\\) to beautify the layout
...
\section{Patch-Based Tokenisation}\label{sec:one}
\input{sections/1_tokenisation_phase_locking.tex}

\section{Proposed Approach: Observability, Agent Behaviour and Mitigation}\label{sec:proposal}
...
\input{sections/2.1_ontology_agent_behaviour.tex}
\endgroup

\subsection{Proposed Mitigation}\label{sec:seven}
\input{sections/2.2_mitigation_proposal.tex}

\section{Research Questions and Experimental Methodology}\label{sec:methodology}
\subsection{Expected Behaviour at Blind-Spot Frequencies}\label{sec:three}
\begingroup
\let\subsubsection\paragraph
\let\subsection\subsubsection
\input{sections/3.1_hypotheses_bayesian_models.tex}
\endgroup

\subsection{Signals and Data}\label{sec:four}
\begingroup
\let\subsection\subsubsection
\input{sections/3.2_signals_data.tex}
\endgroup
...
\let\subsubsection\paragraph
\let\subsection\subsubsection
\input{sections/3.3_experimental_framework.tex}
\endgroup

\section{Results}\label{sec:six}
\input{sections/4_results.tex}

\section{Discussion and Security Risk Assessment}\label{sec:discussion}
\subsection{Mitigation: Evaluation and Further Strategies}\label{sec:mitigationDiscussion}
\begingroup
\let\subsection\subsubsection
\input{sections/5.1_mitigation_discussion.tex}
\endgroup

\subsection{Security Risk Assessment}\label{sec:eight}
\begingroup
\let\subsection\subsubsection
\input{sections/5.2_security_risk_assessment.tex}
\endgroup
