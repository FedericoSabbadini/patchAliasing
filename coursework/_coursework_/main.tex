...
\runninghead{Deliverable 3} % A shortened article title to appear in the running head, leave this command empty for no running head
...
\title{Deliverable 3\\Structural Aliasing Analysis in Time-Series Forecasting Using Chronos} % Article title, use manual lines breaks (\\) to beautify the layout
...
Time-series forcasting relevance and a brief description of the traditional methods; the deep-learning tecniques including fine-tuned architecture and transformers based ones. A brief description of the Chronos family.A simple introduction on signal pre-processing, the Nyquist-Shannon sampling theorem and the aliasing phenomenon.

\section{Patch-Based Tokenization: a Formal Description} \label{sec:one}
\input{sections/one}
\section{Patch-Based Tokenization: Claude} \label{sec:one}
\input{sections/point1.tex}

%----------------------------------------------------------------------------------------

\section{Phase-Locking and Token Space Representation} \label{sec:two}
\input{sections/two}

%----------------------------------------------------------------------------------------

\section{Domain Description and Ontology Representation} \label{sec:three}
