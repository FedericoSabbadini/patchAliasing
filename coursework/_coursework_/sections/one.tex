...
Phase-locking occurs when the structural phase profile of the signal repeats exactly under a translational shift equal to the stride $S$.
...
\subsection{General Patch Indistinguishability Theorem}
