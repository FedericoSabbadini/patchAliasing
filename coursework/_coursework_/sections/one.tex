...
Taking into account two consecutive tokens, and using the element-wise notation from Equation \eqref{eq:element_def} and applying Equation \eqref{eq:general_periodicity} gives
