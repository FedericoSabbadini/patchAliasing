\begin{table}[t]
    ...
    \begin{tabular}{@{}lllp{4.9cm}@{}}
        ...
        \bottomrule
    \end{tabular}
    \caption{Every parameter with its prior and its role. The effect priors are those of Deliverable~1, extended by $\delta_P$, which the design of \autoref{tab:hfModels} makes estimable.}
