...
Finally, the project will focus on the analysis of the phenomenon, through MDL probing after each decoder block to verify the presence, or absence, of frequency information in the hidden states. All effect estimates are obtained through a probabilistic model implemented in PyMC. A \emph{skeptical prior}, $\beta \sim \mathcal{N}(0,\,0.1^2)$ sencodes prior skepticism about the aliasing effect size. An observation-noise prior, $ \sigma \sim \mathrm{HalfNormal}(0.0616)$
