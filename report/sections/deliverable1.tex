...
\begin{itemize}
    \item Patch-based tokenization and patch aliasing formal definition;
    \item Phase-locking analysis;
    \item Formal domain description through ontology of the physical system (photovoltaic array, battery storage, national grid, internal load), signal characteristics (frequency, amplitude, time span, phase) and signal patched representations (patch size, stride, sampling frequency);
    ...
    \item Possible analysis of signals produced with KernelSynth, if previous analyses have produced evidence of aliasing on synthetic data;
