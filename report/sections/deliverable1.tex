...
Initially, the investigation will focus on the definition of the phenomenon, particularly:
\begin{itemize}
...
\begin{itemize}
    ...
    \item evaluation of the model using elementary sinusoidal signals and TSMixup generated ones to verify the presence of blind spots and phase-locking effects. 
\end{itemize}
