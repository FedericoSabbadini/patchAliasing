...
Then, after defining a set of falsifiable hypoteses, including:
\begin{itemize}
    ...
    \item the impact of patch size, stride, and overlap on the phenomenon.
\end{itemize}

The project will then focus on the empirical validation of the phenomenon, through:
\begin{itemize}
...
\begin{itemize}
    ...
    \item Possible mitigation strategies discussion, icluding stride reduction.
\end{itemize}