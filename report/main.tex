...
\runninghead{Structural Aliasing Analysis in Patch-Based Time-Series Foundation Models} % A shortened article title to appear in the running head, leave this command empty for no running head
