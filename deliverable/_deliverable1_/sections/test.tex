...
This statement requires citation \autocite{FastAccurateZeroshot2024}. This statement requires multiple citations \autocite{belroseLEACEPerfectLinear2023}. This statement contains an in-text citation, for directly referring to a citation like so: \textcite{voitaInformationTheoreticProbingMinimum2020}.
